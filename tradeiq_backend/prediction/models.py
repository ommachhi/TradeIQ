...
class ModelHistory(models.Model):
    ...
    train_r_squared = models.FloatField(null=True, blank=True)
    overfit_gap = models.FloatField(null=True, blank=True)
    feature_count = models.PositiveIntegerField(default=0)
    training_samples = models.PositiveIntegerField(default=0)
    testing_samples = models.PositiveIntegerField(default=0)
